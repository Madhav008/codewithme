...
const ChatComponent = ({leaveRoom,copyRoomId}) => {
    return (
        <div>
            <div class="w-full px-5 flex flex-col justify-between overflow-y-auto h-[573px]">
                {/* Header */}
            ...
            <div class="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
                <div class="flex-grow ml-2 mr-2">
                    <div class="relative">
                        <div className='flex border rounded-xl  focus:border-indigo-300 pl-4 h-10'>

                            <input type="text" class="focus:outline-none "></input>
