    ...
    return (
        <div className='w-[50%] m-auto mt-[150px] bg-indigo-100 rounded-lg h-[400px] flex flex-col'>
            <div className='flex flex-col m-auto w-[500px] justify-center' >
                ...
                <button type="submit" className="mx-auto mt-[20px] w-[90px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Join</button>
